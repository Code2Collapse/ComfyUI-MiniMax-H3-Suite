...
class MiniMaxH3EnhancePrompt(io.ComfyNode):
    ...
    def define_schema(cls):
        return io.Schema(
            node_id="MiniMaxH3_EnhancePrompt",
...
NODE_CLASS_MAPPINGS = {"MiniMaxH3_EnhancePrompt": MiniMaxH3EnhancePrompt}
NODE_DISPLAY_NAME_MAPPINGS = {"MiniMaxH3_EnhancePrompt": "MiniMax H3 Enhance Prompt"}
