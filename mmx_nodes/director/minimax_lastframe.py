...
class MiniMaxH3SaveLastFrame(io.ComfyNode):
    ...
    def define_schema(cls):
        return io.Schema(
            node_id="MiniMaxH3_SaveLastFrame",
...
NODE_CLASS_MAPPINGS = {"MiniMaxH3_SaveLastFrame": MiniMaxH3SaveLastFrame}
NODE_DISPLAY_NAME_MAPPINGS = {"MiniMaxH3_SaveLastFrame": "MiniMax H3 Save Last Frame"}
