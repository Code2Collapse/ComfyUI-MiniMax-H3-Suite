...
class MiniMaxH3DirectorChain(io.ComfyNode):
    ...
    def define_schema(cls):
        return io.Schema(
            node_id="MiniMaxH3_DirectorChain",
...
NODE_CLASS_MAPPINGS = {"MiniMaxH3_DirectorChain": MiniMaxH3DirectorChain}
NODE_DISPLAY_NAME_MAPPINGS = {"MiniMaxH3_DirectorChain": "MiniMax H3 Director Chain"}
