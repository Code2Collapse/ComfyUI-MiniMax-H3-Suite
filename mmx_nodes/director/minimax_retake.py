...
class MiniMaxH3RetakeStitch(io.ComfyNode):
    ...
    def define_schema(cls):
        return io.Schema(
            node_id="MiniMaxH3_RetakeStitch",
...
NODE_CLASS_MAPPINGS = {"MiniMaxH3_RetakeStitch": MiniMaxH3RetakeStitch}
NODE_DISPLAY_NAME_MAPPINGS = {"MiniMaxH3_RetakeStitch": "MiniMax H3 Retake Stitch"}
