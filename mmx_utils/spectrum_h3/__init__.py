# PORTED FROM: ComfyUI-Spectrum-MiniMax-H3 :: comfyui_spectrum_h3 @ upstream
# Author: xmarre — Licence: GPL-3.0
"""Spectrum H3 forecasting / objective-media utilities (ported into MiniMaxSuite)."""

from __future__ import annotations

from ._copy_from_third_party import ensure_ported
