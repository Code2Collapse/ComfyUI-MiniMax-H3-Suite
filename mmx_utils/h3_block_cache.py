# Apache License 2.0 — comfyui-minimax-h3-blockcache-T8
# PORTED FROM: comfyui-minimax-h3-blockcache-T8 :: h3_block_cache.py @ HEAD
...
class H3BlockCache:
    ...
    def begin_forward(self, x: torch.Tensor, mod_segments: list, transformer_options: dict):
        ...
        if stream.metadata != metadata or (
            stream.last_sigma is not None and sigma is not None and sigma > stream.last_sigma
        ):
